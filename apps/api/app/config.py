...
class Settings(BaseSettings):
    ...
    # Shared MTProto (teleproxy Fake-TLS) for Telegram — только подписчикам.
    # DNS: tg.bigwinzone.ru → VPS. Public :443 owned by teleproxy (not HAProxy).
    ...
    mtproto_fake_tls_domain: str = "bigwinzone.ru"
