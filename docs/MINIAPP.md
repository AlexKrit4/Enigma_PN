...
- Банк из **20 000 книг** (паттерн + заранее известный результат); за цикл 20 000 ставок возвращается **19 200** дней (RTP 96%)
- **1 из 100** книг — бонус: три «В» → 7 фриспинов с множителем («Х» = +1×); бонусная книга считается как **1 спин** для RTP
- Макс. выигрыш: **30 дней** (👑)
